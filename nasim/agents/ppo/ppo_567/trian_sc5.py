...
save_episodes_return_step_list(r"D:\Nasim-Zsy-ppo\nasim\nasim\train_data\sc5\ppo_sc5_return.csv", episodes_list, return_list, step_list)

episodes_csv, return_csv, step_csv = read_episodes_return_step_list(r"D:\Nasim-Zsy-ppo\nasim\nasim\train_data\sc5\ppo_sc5_return.csv")
plot_save_to_pic_episode_return(r"D:\Nasim-Zsy-ppo\nasim\nasim\train_data\sc5\ppo_sc5_return.png",episodes_csv, return_csv,'PPO',env_name)
plot_save_to_pic_episode_return(r"D:\Nasim-Zsy-ppo\nasim\nasim\train_data\sc5\ppo_sc5_step.png",episodes_csv,step_csv,'PPO',env_name)
