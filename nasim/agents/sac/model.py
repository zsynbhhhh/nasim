...
class PolicyNetContinuous(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        action = action * self.action_bound # 对action求取范围
...
class SACContinuous:
    ...
    def calc_target(self, rewards, next_states, dones):
        next_actions, log_prob = self.actor(next_states) # 获得下一个时刻的动作和概率值
        entropy = -log_prob  #
        q1_value = self.target_critic_1(next_states, next_actions) # 获得下一个时刻的q1_value
